...
const includedFeatures = [
    ...
    'Expense & Running Costs Tracking',
];
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl sm:text-center">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-600">
                        Everything you need to manage your property portfolio with confidence. No hidden fees, just reliable automation.
                    </p>
                </div>
                <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                    <div className="p-8 sm:p-10 lg:flex-auto">
                        ...
                        <p className="mt-6 text-base leading-7 text-gray-600">
                            Our all-in-one plan designed for growth-minded property agencies and landlords.
                            Get full access to all KodiPay mobile features.
                        </p>
                    ...
                    <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                        <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16 h-full">
                            <div className="mx-auto max-w-xs px-8">
                                ...
                                <a
                                    href="/docs"
                                    className="mt-10 block w-full rounded-md bg-blue-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition-all"
                                >
                                    Get Access Now
                                </a>
                                <p className="mt-6 text-xs leading-5 text-gray-600">
                                    Invoices and receipts generated automatically in KES for your records.
                                </p>
                            </div>
                        </div>
                    </div>
