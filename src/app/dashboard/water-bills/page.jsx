        ...
        <div className="space-y-8 animate-in fade-in duration-500 text-left">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-xs text-[#64748B] mt-1 uppercase tracking-widest">Manage monthly water billing and utility consumptions for {displayMonth}</p>
                </div>
                                                    ...
                                                    <div className="space-y-0.5">
                                                        ...
                                                        {isIndividual && consumed > 0 && (
                                                            <p className="text-[9px] font-bold text-[#94A3B8] uppercase tracking-wider">
                                                                {consumed.toLocaleString()} Units used
                                                            </p>
                                                        )}
                                                    </div>
                                                </td>
